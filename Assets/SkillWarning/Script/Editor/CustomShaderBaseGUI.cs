...
#region Properties
        ...
        public virtual void DrawAdvancedOptions(MaterialEditor materialEditor)
        {
            // Get Material
            var material = materialEditor.target as Material;
...
#region Workflow
        ...
        public static bool IsSpecularWorkflow(this Material material)
        {
            ...
            return (CustomShaderBaseGUI.WorkflowMode)material.GetFloat("_WorkflowMode") == CustomShaderBaseGUI.WorkflowMode.Specular;
        }
#endregion
